...
// checks if the PhoneUserJsonld type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhoneUserJsonld{}

// PhoneUserJsonld 
type PhoneUserJsonld struct {
	...
	Tweets []TweetJsonld `json:"tweets,omitempty"`
...
// SetTweets gets a reference to the given []TweetJsonld and assigns it to the Tweets field.
...
func (o PhoneUserJsonld) MarshalJSON() ([]byte, error) {
...
func (o PhoneUserJsonld) ToMap() (map[string]interface{}, error) {
...
type NullablePhoneUserJsonld struct {
	value *PhoneUserJsonld
	isSet bool
}

func (v NullablePhoneUserJsonld) Get() *PhoneUserJsonld {
	return v.value
}

func (v *NullablePhoneUserJsonld) Set(val *PhoneUserJsonld) {
	v.value = val
	v.isSet = true
}

func (v NullablePhoneUserJsonld) IsSet() bool {
	return v.isSet
}

func (v *NullablePhoneUserJsonld) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhoneUserJsonld(val *PhoneUserJsonld) *NullablePhoneUserJsonld {
	return &NullablePhoneUserJsonld{value: val, isSet: true}
}

func (v NullablePhoneUserJsonld) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhoneUserJsonld) UnmarshalJSON(src []byte) error {
	v.isSet = true
