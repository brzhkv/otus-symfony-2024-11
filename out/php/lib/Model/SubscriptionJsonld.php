...
/**
 * SubscriptionJsonld Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class SubscriptionJsonld implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Subscription.jsonld';
    ...
    */
     ...
     * Sets author
     *
     * @param mixed|null $author author
     *
     * @return self
     */
     ...
     * Sets follower
     *
     * @param mixed|null $follower follower
     *
     * @return self
     */
    ...
    {
        if (is_null($follower)) {
            array_push($this->openAPINullablesSetToNull, 'follower');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('follower', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
