...
class Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'tweets' => '\OpenAPI\Client\Model\TweetDTO[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tweets'] === null) {
            $invalidProperties[] = "'tweets' can't be null";
        }
     ...
     * Gets tweets
     *
     * @return \OpenAPI\Client\Model\TweetDTO[]
     */
     ...
     * Sets tweets
     *
     * @param \OpenAPI\Client\Model\TweetDTO[] $tweets Твиты
     *
     * @return self
     */
